...
#ifndef BOB_BOOST_RANDOM_NORMAL_DISTRIBUTION_HPP
#define BOB_BOOST_RANDOM_NORMAL_DISTRIBUTION_HPP
...
generate_one_digit(Engine& eng, std::size_t bits)
{
    ...
    base_unsigned u;
    do {
        u = boost::random::detail::subtract<base_result>()(eng(), (eng.min)());
...
#endif // BOB_BOOST_RANDOM_NORMAL_DISTRIBUTION_HPP
